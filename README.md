# ⚛ React 🔥 Firebase CRUD Firestore App

### Quickstart

It's pretty straightforward to add this to your project - it's just like any dependency.
...
You should then be able to navigate to http://localhost:3000 an view the UI.

### Spanish HOWTO do a simple Crud using React and Firebase
...
> crud-react-firebase-8f4ee (crud-react-firebase)
```
...
Nos muestra el siguiente mensaje si todo salio OK en donde lo mas importante es el `Hosting URL: https://crud-react-firebase-8f4ee.web.app`
que es de donde podemos acceder a la app ツ

```
=== Deploying to 'crud-react-firebase-8f4ee'...
...
i  hosting[crud-react-firebase-8f4ee]: beginning deploy...
i  hosting[crud-react-firebase-8f4ee]: found 16 files in build
+  hosting[crud-react-firebase-8f4ee]: file upload complete
+  firestore: released rules firestore.rules to cloud.firestore
i  hosting[crud-react-firebase-8f4ee]: finalizing version...
+  hosting[crud-react-firebase-8f4ee]: version finalized
i  hosting[crud-react-firebase-8f4ee]: releasing new version...
+  hosting[crud-react-firebase-8f4ee]: release complete

+  Deploy complete!

Project Console: https://console.firebase.google.com/project/crud-react-firebase-8f4ee/overview
Hosting URL: https://crud-react-firebase-8f4ee.web.app
```
